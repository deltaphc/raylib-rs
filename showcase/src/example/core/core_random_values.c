    ...
    ->crate::SampleOut
{
    ...
    int randValue = raylib::get_random_value(-8, 5); // Get a random integer number between -8 and 5 (both included)
    ...
    return Box::new(move |rl: &mut RaylibHandle, thread: &RaylibThread| -> () // Detect window close button or ESC key
    {
        ...
        d.draw_text(FormatText("%i", randValue), 360, 180, 80, Color::LIGHTGRAY);
